...
*/		
   ...
   //Default Starting Page Results
	...
	$("#content").load("pagination_data_popular.php?page=1", Hide_Load());
...
<aside class="placeholder">
	...
	<aside class="placeholder">
            ...
            <div class="favoritefulu">
            	...
            	<aside class="tabsleft"> <a class="tabs tabs1" href="fulus.php"><span>Most recent</span></a></aside>
                <aside class="tabsright"><a class="tabs active" href="popular.php"><span>Most Popular</span></a></aside>
                </aside>
