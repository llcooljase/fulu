...
//					var sortMethod = $(this).attr("sortMethod");
					...
					$(this).parent().prev().load("fulumachine.php?page="+prevpage+"&pages=<?php echo $pages;?>&sort=recent");
				});
</script>
...
<script>
				$(".next").click(function() {
					...
					if (nextpage == <?php echo $pages;?>) {return false}
					var prevpage = nextpage - 2;
//					var sortMethod = $(this).attr("sortMethod");
					
 					$(this).attr("page",nextpage+1);
					$(this).prevAll('.prev').attr("page",prevpage+1);
					$(this).parent().prev().load("fulumachine.php?page="+nextpage+"&pages=<?php echo $pages;?>&sort=recent");
				});
</script>
</div>
